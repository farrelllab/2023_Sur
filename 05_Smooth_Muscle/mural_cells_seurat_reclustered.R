...
##Plot  stage information on the non-skeletal muscle atlas UMAP - Figure S5A
stage.colors.new <- c(
...
##Plot the comparative dotolot between pericytes, vascular SMCs and visceral SMCs - Figure 3B
...
##Plot the full list of differentially expressed pericyte genes across the pericyte populations - Figure S5B
...
##Make a small dotplot highlighting some of the key differentially expressed markers between the pericyte populations - Figure 3C
...
##IV. How are vascular and visceral SMCs transcriptoinally different from each other? - Figure S5C
...
##V. Plot gene expression for specific genes on the UMAP projections - Figure 3D, Figure 4B, and Figure S6A,C,E
...
##VI. Comparing gene expression between the intestinal longitudinal and circular muscles - Figure 4A
...
##After the number of ndufa4l2a and epas1a expressing cells were counted from the microscopy data, the following code was used to plot the relevant graphs shown in Figure 3H and 3L. 
