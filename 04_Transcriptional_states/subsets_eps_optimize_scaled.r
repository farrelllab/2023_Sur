#This script is to optimize a radius in mama that would be considered an universal eps across all tissues
...
##Assign paths
save.path <- paste0(base.path, "/knn_neighbors_scaled/")
plot.path <- paste0(base.path, "/plots_mat_scaled/")
dist.path <- paste0(old.base.path, "/dist_subsets_scaled/")
...
mat.path.data <- "/data/CSD/zfext/LTA/results/13-EPS/mat_subsets_scaled/"
...
mat <- readRDS(paste0(dist.path.scaled, sample, "_dist_mat_scaled.rds"))
